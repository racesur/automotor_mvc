...
class Vendedor extends ActiveRecord
{
    ...
    protected static $columnasDB = ['id', 'nombre', 'apellido', 'puesto', 'telefono', 'imagen']; //Con esto mapeamos los datos para que se emparejen con las columnas de la bbdd
    ...
    public function validar() //hereda el metodo
    {
        ...
        if (!preg_match('/[0-9]{9}/', $this->telefono)) { //Ejecuta un código de una expresion regular o patron dentro de un texto. Con / le decimos que el tmño sea fijo, y con 0-9 que los valores q acepta son de 0 a 9, y con las llaves le indicamos el tamaño del numero y el segundo argumento que revise el contenido del campo telefono
