<fieldset>
    ...
    <input type="text" name="blog[subtitulo]" id="subtitulo" placeholder="Subtitulo Blog" value="<?php echo s($blog->subtitulo); ?>">
...
<fieldset>
    ...
    <select name="blog[vendedorId]" id="vendedor">
        ...
        <?php foreach ($vendedores as $vendedor) : ?>
            <option <?php echo $blog->vendedorId === $vendedor->id ? 'selected' : ''; ?> value="<?php echo s($vendedor->id); ?>">
