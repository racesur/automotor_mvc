    ...
    <div class="contenido-nosotros">
        ...
        <div class="texto-nosotros">
            ...
            <p>En nuestro concesionario, creemos que el servicio al cliente es la clave del éxito en la industria
                automotriz. Por esta razón, nuestro equipo de vendedores se esfuerza por brindar un servicio excepcional
    ...
    <div class="iconos-nosotros">
        <div class="icono">
            ...
            <p>Además de la venta de vehículos, también ofrecemos servicios de mantenimiento y reparación en nuestro
                taller
                de servicio. Nuestros mecánicos altamente capacitados y experimentados están disponibles para realizar
        ...
        <div class="icono">
            ...
            <h3>Financiación</h3>
            <p>En Automotor, entendemos que la compra de un vehículo es una gran inversión. Por lo tanto, nos aseguramos
                de
